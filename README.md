...
[![Pub package](https://img.shields.io/pub/v/multi_downloader.svg?style=flat-square)](https://pub.dartlang.org/packages/multi_downloader)
[![build status](https://img.shields.io/travis/com/warith313/multi_downloader?style=flat-square)](https://travis-ci.org/warith313/multi_downloader)
[![support](https://img.shields.io/badge/platform-Flutter%7CAndroid%7CIOS-ff69b4.svg?style=flat-square)](https://github.com/warith313/multi_downloader)
...
<img width="512" src="https://github.com/warith313/multi_downloader/blob/master/screenshot/enable_background_mode.png?raw=true"/>

* Add `sqlite` library.

<p>
    <img width="512" src="https://github.com/warith313/multi_downloader/blob/master/screenshot/add_sqlite_1.png?raw=true" />
</p>
<p style="margin-top:30;">
    <img width="512" src="https://github.com/warith313/multi_downloader/blob/master/screenshot/add_sqlite_2.png?raw=true" />
</p>
...
````xml
<string name="multi_downloader_notification_started">Download started</string>
<string name="multi_downloader_notification_in_progress">Download in progress</string>
<string name="multi_downloader_notification_canceled">Download canceled</string>
<string name="multi_downloader_notification_failed">Download failed</string>
<string name="multi_downloader_notification_complete">Download complete</string>
<string name="multi_downloader_notification_paused">Download paused</string>
````
