...
class DownloadTask {
  ...
  @override
  String toString() =>
      "DownloadTask(taskId: $taskId, status: $status, progress: $progress, url: $url, filename: $filename, image: $image, srt: $srt, name: $name, savedDir: $savedDir, timeCreated: $timeCreated)";
}
