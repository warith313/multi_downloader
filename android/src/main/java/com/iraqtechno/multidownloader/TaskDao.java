...
public class TaskDao {
    ...
    final private String[] projection = new String[]{
            ...
            TaskContract.TaskEntry.COLUMN_NAME_IMAGE,
            TaskContract.TaskEntry.COLUMN_NAME_SRT,
    ...
    public void insertOrUpdateNewTask(String taskId, String url, int status, int progress, String fileName, String image, String srt, String name,
        ...
        values.put(TaskContract.TaskEntry.COLUMN_NAME_IMAGE, image);
        values.put(TaskContract.TaskEntry.COLUMN_NAME_SRT, srt);
    ...
    private DownloadTask parseCursor(Cursor cursor) {
        ...
        String image = cursor.getString(cursor.getColumnIndexOrThrow(TaskContract.TaskEntry.COLUMN_NAME_IMAGE));
        String srt = cursor.getString(cursor.getColumnIndexOrThrow(TaskContract.TaskEntry.COLUMN_NAME_SRT));
        ...
        return new DownloadTask(primaryId, taskId, status, progress, url, filename, image, srt, name, savedDir, headers,
