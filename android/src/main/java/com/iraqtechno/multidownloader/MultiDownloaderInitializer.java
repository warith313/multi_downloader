...
public class MultiDownloaderInitializer extends ContentProvider {
    ...
    private int getMaxConcurrentTaskMetadata(Context context) {
        try {
            ProviderInfo pi = context.getPackageManager().getProviderInfo(
                    new ComponentName(context, "com.iraqtechno.multidownloader.MultiDownloaderInitializer"),
                    PackageManager.GET_META_DATA);
            Bundle bundle = pi.metaData;
            int max = bundle.getInt("com.iraqtechno.multidownloader.MAX_CONCURRENT_TASKS", DEFAULT_MAX_CONCURRENT_TASKS);
